...
let list_Product = [{
    ...
    {
        img: "../../img/all-product-page/pastel/pastel5.jpeg",
        title: "Tango Bottoms",
        des: "Navy Rib",
        price: 380,
        isNew: false,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel9.jpeg",
        title: "Triangle cream top",
        des: "Persimmon Jacquard",
        price: 190,
        isNew: false,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel10.jpg",
        title: "Sharong clutch",
        des: "White Crinkle Linen",
        price: 75,
        isNew: true,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel8.jpeg",
        title: "Camel set",
        des: "White Crinkle Linen",
        price: 750,
        isNew: true,
