...
let list_Product = [{
    ...
    {
        img: "../../img/all-product-page/all-products14.jpeg",
        title: "Amelia short Beachwear",
        des: "White Crinkle Linen",
        price: 75,
        isNew: true,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/all-products12.jpeg",
        title: "Jaguar Bottoms",
        des: "White Crinkle Linen",
        price: 235,
        isNew: true,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/all-products24.jpeg",
        title: "T strap Top",
        des: "White Crinkle Linen",
        price: 129,
        isNew: true,
    ...
    {
        img: "../../img/all-product-page/one/one11.jpeg",
        title: "Skimer One pieces",
        des: "White Crinkle Linen",
        price: 370,
        isNew: true,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/one/one9.jpeg",
        title: "Bari Dark Linen",
        des: "BlackCrinkle Linen",
        price: 75,
        isNew: true,
        saleOff: true,
        like_new: false,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel1.jpeg",
        title: "Isla Top",
        des: "Professional",
        price: 100,
        isNew: true,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel2.jpeg",
        title: "Brazilian coverage",
        des: "Brazilian coverage",
        price: 80,
        isNew: false,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel3.jpeg",
        title: "Bahamas cream set",
        des: "White Sand Crinkle",
        price: 690,
        isNew: true,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel4.jpeg",
        title: "Irovy Bottoms",
        des: "White Sand Crinkle",
        price: 90,
        isNew: true,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel6.jpeg",
        title: "Cream Sand Crinkle",
        des: "White Sand Crinkle",
        price: 80,
        isNew: true,
        saleOff: true,
    ...
    {
        img: "../../img/all-product-page/pastel/pastel7.jpeg",
        title: "Rream sandy",
        des: "White Sand Crinkle",
        price: 180,
        isNew: true,
