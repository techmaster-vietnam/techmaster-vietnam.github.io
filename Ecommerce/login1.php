  ...
  <?php
    ...
    if($username==""){
      ...
      if($count==1){
        ...
        echo "<p>The account is not existed. Please login by another account. Thank you so much!</p>";
      }
      }
  }
    ?>
    ...
    <div id="login">
      ...
      <form action="login1.php" method="post">
        <div class="container">
          ...
          <label for="">Welcome! Please complete the information below to login!</label>
          <div class="row">
